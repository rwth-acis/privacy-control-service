...
RUN apk add --update bash tzdata curl dos2unix && rm -f /var/cache/apk/*
...
RUN dos2unix /src/etc/i5.las2peer.services.privacy_control_service.PrivacyControlService.properties
